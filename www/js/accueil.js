...
function loadAccueil () {
    ...
    pageBody.innerHTML = `
    <main class="flex flex-col p-4 bg-slate-300 min-h-screen text-lime-900 font-semibold">
        <img src="./img/KitadiLogo.png" class="mb-8" />
        ...
        <div class="relative overflow-x-auto">
            <table id="tableProjets" class="w-full text-sm text-gray-400 text-center">
