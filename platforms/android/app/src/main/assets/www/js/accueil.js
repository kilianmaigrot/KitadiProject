...
setTimeout(() => {
  ...
  btnRetour.addEventListener('click', function(){
      ...
      const confirmation =  confirm(`Vos données ne seront pas sauvegardées. Voulez-vous retourner à l'accueil ?`);
      if(confirmation){
          loadAccueil();
      }else{
           return;
          ...
          for (i = 0; i < len; i++) {       
              ...
              <div class="accordion">
                ...
                <div class="accordion-content">
                  <div class="flex flex-col text-center border-4 border-cyan-500 p-4">
                      <h3>Nom</h3>
                      <input type="text" id="nomClient"  value="${results.rows.item(i).Nom.toUpperCase()}"  class="input-field bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500"/>
                      <h3>Prénom</h3>
                      <input type="text" id="prenomClient"  value="${results.rows.item(i).Prenom}" class="input-field bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500"/>
                      <h3>Adresse</h3>
                      <input type="text" id="adresseClient" value="${results.rows.item(i).Adresse}" class="input-field bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500"/>
                      <h3>Code Postal</h3>
                      <input type="text" id="codePostal" value="${results.rows.item(i).CodPostal}" class="input-field bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500"/>
                      <h3>Ville</h3>
                      <input type="text" id="villeClient" value="${results.rows.item(i).Ville}" class="input-field bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500"/>
                      <h3>Téléphone</h3>
                      <input type="text" id="telClient" value="${results.rows.item(i).Tel}" class="input-field bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500"/>
                      <h3>e-mail</h3>
                      <input type="text" id="mailClient" value="${results.rows.item(i).Mail}" class="input-field bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500"/>
                  </div>
                  </div>
              </div>`
      ...
      transaction.executeSql(`SELECT * FROM Piece WHERE Client_Id = ?`, [idClient], function (tx, results) {
          ...
          for (i = 0; i < len; i++) {  
              ...
              '<h2 class="text-center">Température de base||</h2>'+
                  ...
                  '<div class="flex-col">'+
              '<h2 class="text-center">Température de confort</h2>'+
                      `<input type="number" id="tempConfort${i}" value="${results.rows.item(i).TempConfort}" class="bg-gray-50 border w-24 border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500"/>`+
                  '</div>'+
                  `<div id="deltaT${i}"></div>`+ //-- Calcul des temperatures --//
              '</div>'+
