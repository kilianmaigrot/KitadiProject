        ...
        for (i = 0; i < len; i++) {
          tableProjets.innerHTML += `
            ...
            results.rows.item(i).Prenom
                    ...
                    <td>${results.rows.item(i).Adresse}<br/>${
  ...
  function creationPieceDossier(idClient) {
    ...
    if (idClient > 0) {
      ...
      for (let j = 0; j <= i; j++) {
        ...
        console.log("Après les Let...");

        console.log(reqNomPiece);
        console.log(`nomPiece${j}`);
        console.log(idClient);
        
        console.log("Après les consoles de masse...");
